...
export class CustomizedStatementPage extends BasePage {
    constructor(page) {
        ...
        this.minimumTransactionValueInput = this.page.locator('input[name="amountlowerlimit"]');
        this.numberOfTransactionInput = this.page.locator('input[name="numtransaction"]');
        this.submitButton = page.locator('input[type=submit]');
        this.customizedStatementLabel = page.locator('p[class=heading3]');
        this.customizedStatementClick = page.locator('a[href= "CustomisedStatementInput.php"]');
    ...
    async verifyCustomisedStatementForm() {
        await expect(this.customizedStatementLabel).toContainText('Customized Statement Form');
    }
    ...
    async verifyCustomisedStatementSuccessfully() {
        await expect(this.customizedStatementMsg).toContainText('Customized Statement');
